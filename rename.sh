...
echo "Renaming all 'WeeklyChargesJobApi' -> '$PASCAL'"
echo "Renaming all 'WeeklyChargesJobApi' -> '$CAMEL'"
...
find . -type d -not -path '*/\.git/*' | sed -e "p;s/WeeklyChargesJobApi/$PASCAL/" | xargs -n2 mv
find . -type d -not -path '*/\.git/*' | sed -e "p;s/WeeklyChargesJobApi/$CAMEL/" | xargs -n2 mv
# file names
...
find . -type f -not -path '*/\.git/*' | sed -e "p;s/WeeklyChargesJobApi/$PASCAL/" | xargs -n2 mv
find . -type f -not -path '*/\.git/*' | sed -e "p;s/WeeklyChargesJobApi/$CAMEL/" | xargs -n2 mv
# strings
find . -type f -not -path '*/\.git/*' -exec sed -i "s/base_api/$SNAKE/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/base-api/$KEBAB/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/WeeklyChargesJobApi/$PASCAL/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/WeeklyChargesJobApi/$CAMEL/g" {} \;
